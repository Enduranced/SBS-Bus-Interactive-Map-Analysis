...
#####################   DataFrames  ############################
df1 = pd.read_csv("https://raw.githubusercontent.com/Enduranced/SBS-Bus-Interactive-Map-Analysis/main/Data/SingaporeHousingDistri.csv")
...
mi = min(df1['Population Distribution'])
ma = max(df1['Population Distribution'])

fig = px.choropleth_mapbox(df1, geojson=counties, locations='Location', color='Population Distribution',
